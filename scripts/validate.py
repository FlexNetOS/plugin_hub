...
# ─── per-hub constants ────────────────────────────────────────────────────────
COLLECTION = "plugins"
CHILD_TOKEN = "plugin_hub-child"
BASE_REQUIRED = ["id", "displayName", "status", "summary", "doc"]
BESPOKE_REQUIRED = ["category", "installSource"]
ENUMS = {
    "status": {"stable", "beta", "experimental", "deprecated"},
    "category": {"marketplace", "plugin"},
    "installSource": {"git", "git-subdir", "local"},
    "hosting": {"peer", "plugin_hub-child", "registry-only"},
}
FILE_REF_FIELDS = ["doc", "snippet"]
JSON_REF_FIELDS = ["snippet"]
# ──────────────────────────────────────────────────────────────────────────────
